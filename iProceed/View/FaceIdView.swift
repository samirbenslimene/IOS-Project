...
//  iProceed
//
//  Created by Apple Mac on 26/12/2021.
//
...
class FaceIdView: UIViewController {

    var userToBePaid : User?
    ...
    var state = AuthenticationState.loggedout {
        ...
        didSet {
            ...
            if state == .loggedin {
                self.performSegue(withIdentifier: "paySegue", sender: userToBePaid)
